...
`phone`, `status`) VALUES
('mmysqlmydbet', 'Tran Thi Met', '123', 'met@gmail.com', '0904567890', 1),
...
('admin', 'teo', b'1', ''),
('user', 'met', b'1', '');
-- Dumping structure for table mydb.logmydb
...
COLLATE=latin1_swedish_ci COMMENT='ghi logs';rolerolerole
